...
test('Демон с атакой 100 и дурманом', () => {
...
test('Демон с атакой 100 и без дурмана', () => {
  const daemon = new Daemon('Lutik', null, 2);
  daemon.attack = 100;
  daemon.stoned = false;
...
test('Волшебник с атакой 100 и дурманом', () => {
...
test('Волшебник с атакой 100 и без дурмана', () => {
